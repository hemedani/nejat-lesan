          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-medium text-gray-900">روند کلی</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-medium text-gray-900">تغییر ماهانه</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-medium text-gray-900">پیش‌بینی</h3>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-sm text-orange-700">
                ...
                <li className="flex items-center gap-2">
                  ...
                  مقایسه روند با شاخص‌های اقتصادی و اجتماعی
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-medium text-gray-900">نکات قابل توجه</h4>
                  <div className="space-y-3">
