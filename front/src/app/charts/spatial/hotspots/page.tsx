        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-8 mb-8 border border-red-200">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
                سیستم شناسایی نقاط داغ تصادفات به زودی در دسترس خواهد بود. این ابزار قدرتمند برای شناسایی دقیق مکان‌های پرخطر، ارزیابی ریسک و ارائه راهکارهای بهبود ایمنی طراحی شده است.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="bg-gray-50 rounded-lg h-64 flex items-center justify-center mb-4 relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  ...
                  <p className="text-gray-600 text-sm font-medium">نقشه حرارتی پیش‌نمایش</p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-gray-900 mb-3">🎯 الگوریتم‌های تشخیص</h4>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">الگوریتم کرنل گاوسین</p>
                      <p className="text-xs text-gray-600">برای تشخیص تجمع نقاط تصادف</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">تحلیل فضایی خودکار</p>
                      <p className="text-xs text-gray-600">شناسایی الگوهای پنهان در داده‌ها</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">ارزیابی آماری معنی‌داری</p>
                      <p className="text-xs text-gray-600">تایید علمی وجود نقاط داغ</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-3">📊 گزارش‌گیری هوشمند</h4>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">رتبه‌بندی خطر</p>
                      <p className="text-xs text-gray-600">اولویت‌بندی نقاط برای مداخله</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">پیش‌بینی توسعه</p>
                      <p className="text-xs text-gray-600">پیش‌بینی تغییر شدت نقاط داغ</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">راهکارهای بهبود</p>
                      <p className="text-xs text-gray-600">پیشنهاد اقدامات کاهش خطر</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  این سیستم با استفاده از الگوریتم‌های پیشرفته GIS و تحلیل‌های آماری فضایی برای شناسایی دقیق نقاط داغ تصادفات طراحی شده است.
                </p>
