  ...
  series: [
    {
      ...
      data: [
        12.5, 15.3, 18.2, 14.7, 16.8, 13.4, 19.1, 17.6, 15.9, 14.2, 16.3, 13.8,
      ],
    },
  ],
};
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  تحلیل روند درصد تصادفات فوتی در بین تصادفات شدید در بازه‌های
                  زمانی مختلف
                </p>
              </div>
            ...
            {chartData && !isLoading && !isDemoMode && stats && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-sm text-green-700">
                  تحلیل {stats.periods} دوره زمانی - میانگین: {stats.average}% -
                  حداکثر: {stats.max}% ({stats.maxPeriod}) - حداقل: {stats.min}%
                  ({stats.minPeriod}) - محدوده نوسان: {stats.range}%
                </p>
              </div>
            )}
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm text-blue-700">
                      ...
                      <li>
                        • این تحلیل درصد تصادفات فوتی را در بین تصادفات شدید
                        نشان می‌دهد
                      </li>
                      <li>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="bg-white bg-opacity-50 rounded-lg p-4">
                    ...
                    <ul className="space-y-1 text-blue-700">
                      <li>
                        • دوره {stats.maxPeriod} دارای بیشترین سهم تصادفات فوتی
                        است
                      </li>
                      <li>
                        • دوره {stats.minPeriod} دارای کمترین سهم تصادفات فوتی
                        است
                      </li>
