          ...
          <div className="space-y-6">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">تحلیل روند تصادفات در طول زمان</p>
                    </div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">بررسی الگوهای فصلی تصادفات</p>
                    </div>
                  </div>
                </a>
                <a
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">تحلیل‌های زمانی</h3>
                <p className="text-gray-600">
                  تحلیل‌های مقایسه زمانی در حال توسعه می‌باشد.
                  <br />
                  شامل نمودارهای سری زمانی، تحلیل روند، و مقایسه‌های دوره‌ای خواهد بود.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <h3 className="font-medium text-blue-800 mb-3">ویژگی‌های در دست توسعه</h3>
