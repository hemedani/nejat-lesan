...
import { getCounts } from "../actions/user/dashboardStatistic";
...
const AdminDashboard = async () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-10 gap-4"> {/* Adjusted gap and responsive cols */}
        <StatCard
        ...
        <StatCard
          ...
          bgColor="bg-slate-500" // Using a different shade
        />
        <StatCard
        ...
        <StatCard
          ...
          bgColor="bg-red-400" // Re-using color families with different shades
        />
        <StatCard
        ...
        />
        <StatCard
          description="تعداد انواع عمومی ثبت شده" // Generic title for 'types'
          title="انواع (کلی)"
          value={data?.types}
          bgColor="bg-cyan-400"
        />
