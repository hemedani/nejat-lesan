                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border-2 border-red-200 hover:border-red-300 transition-colors cursor-pointer hover:shadow-md">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      نمایش حرارتی و خوشه‌ای تصادفات
                    </p>
                  </div>
                </div>
              </Link>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 max-w-md mx-auto mb-6">
                  ...
                  این بخش شامل نمایش تصادفات روی نقشه و ابزارهای تحلیل مکانی
                  خواهد بود.
                </p>
                <div className="text-sm text-gray-500">
                  قابلیت‌ها: نمایش روی نقشه، فیلترهای مکانی، تحلیل کلاستر، و
                  محاسبه شعاع تأثیر
                </div>
              </div>
            </div>
