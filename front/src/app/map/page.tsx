...
function MapContent() {
  ...
  const fetchAccidents = useCallback(
    async (polygon?: { type: "Polygon"; coordinates: any[] }) => {
      try {
        setLoading(true);
        setError(null);
  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="bg-gray-300 px-6 py-4 border-b border-gray-400 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {isPolygonSearchMode ? "لغو انتخاب" : "جستجوی چندضلعی"}
            </button>
                ...
                <div className="text-gray-400 mb-4">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.513-.751-6.28-2.028.34-.542.775-.990.28-1.972C7.36 10.48 9.592 10 12 10s4.64.48 5.72 1.472c.495.982.06 1.43.28 1.972C16.513 14.249 14.34 15 12 15z"
                    />
                  </svg>
                </div>
          ...
          {!loading && !error && accidents.length > 0 && (
            <div className="absolute top-4 left-4 z-20 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-slate-200 p-4 min-w-[220px]">
              <h3 className="font-bold text-slate-800 mb-3 flex items-center gap-2">
                <div
                  className={`w-3 h-3 ${drawnPolygon ? "bg-purple-600" : "bg-blue-600"} rounded-full`}
                ></div>
