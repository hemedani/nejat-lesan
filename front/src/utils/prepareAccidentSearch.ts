...
export const prepareAccidentsSearch = async (searchParams: GetAccidentsSetParams) => {
  ...
  if (setSearch?.province && setSearch.province.length > 0) {
    const response = await getProvinces({
      set: { names: setSearch.province, page: 1, limit: setSearch.province.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.city && setSearch.city.length > 0) {
    const response = await getCities({
      set: { names: setSearch.city, page: 1, limit: setSearch.city.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.road && setSearch.road.length > 0) {
    const response = await getRoads({
      set: { names: setSearch.road, page: 1, limit: setSearch.road.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.trafficZone && setSearch.trafficZone.length > 0) {
    const response = await getTrafficZones({
      set: { names: setSearch.trafficZone, page: 1, limit: setSearch.trafficZone.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.cityZone && setSearch.cityZone.length > 0) {
    const response = await getCityZones({
      set: { names: setSearch.cityZone, page: 1, limit: setSearch.cityZone.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.accidentType && setSearch.accidentType.length > 0) {
    const response = await getTypes({
      set: { names: setSearch.accidentType, page: 1, limit: setSearch.accidentType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.position && setSearch.position.length > 0) {
    const response = await getPositions({
      set: { names: setSearch.position, page: 1, limit: setSearch.position.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.rulingType && setSearch.rulingType.length > 0) {
    const response = await getRulingTypes({
      set: { names: setSearch.rulingType, page: 1, limit: setSearch.rulingType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.lightStatus && setSearch.lightStatus.length > 0) {
    const response = await getLightStatuses({
      set: { names: setSearch.lightStatus, page: 1, limit: setSearch.lightStatus.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.collisionType && setSearch.collisionType.length > 0) {
    const response = await getCollisionTypes({
      set: { names: setSearch.collisionType, page: 1, limit: setSearch.collisionType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.roadSituation && setSearch.roadSituation.length > 0) {
    const response = await getRoadSituations({
      set: { names: setSearch.roadSituation, page: 1, limit: setSearch.roadSituation.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.roadRepairType && setSearch.roadRepairType.length > 0) {
    const response = await getRoadRepairTypes({
      set: { names: setSearch.roadRepairType, page: 1, limit: setSearch.roadRepairType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.shoulderStatus && setSearch.shoulderStatus.length > 0) {
    const response = await getShoulderStatuses({
      set: { names: setSearch.shoulderStatus, page: 1, limit: setSearch.shoulderStatus.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleColor && setSearch.vehicleColor.length > 0) {
    const response = await getColors({
      set: { names: setSearch.vehicleColor, page: 1, limit: setSearch.vehicleColor.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleSystem && setSearch.vehicleSystem.length > 0) {
    const response = await getSystems({
      set: { names: setSearch.vehicleSystem, page: 1, limit: setSearch.vehicleSystem.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehiclePlaqueType && setSearch.vehiclePlaqueType.length > 0) {
    const response = await getPlaqueTypes({
      set: { names: setSearch.vehiclePlaqueType, page: 1, limit: setSearch.vehiclePlaqueType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleSystemType && setSearch.vehicleSystemType.length > 0) {
    const response = await getSystemTypes({
      set: { names: setSearch.vehicleSystemType, page: 1, limit: setSearch.vehicleSystemType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleFaultStatus && setSearch.vehicleFaultStatus.length > 0) {
    const response = await getFaultStatuses({
      set: { names: setSearch.vehicleFaultStatus, page: 1, limit: setSearch.vehicleFaultStatus.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleInsuranceCo && setSearch.vehicleInsuranceCo.length > 0) {
    const response = await getInsuranceCos({
      set: { names: setSearch.vehicleInsuranceCo, page: 1, limit: setSearch.vehicleInsuranceCo.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehiclePlaqueUsage && setSearch.vehiclePlaqueUsage.length > 0) {
    const response = await getPlaqueUsages({
      set: { names: setSearch.vehiclePlaqueUsage, page: 1, limit: setSearch.vehiclePlaqueUsage.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleBodyInsuranceCo && setSearch.vehicleBodyInsuranceCo.length > 0) {
    const response = await getBodyInsuranceCos({
      set: { names: setSearch.vehicleBodyInsuranceCo, page: 1, limit: setSearch.vehicleBodyInsuranceCo.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.vehicleMotionDirection && setSearch.vehicleMotionDirection.length > 0) {
    const response = await getMotionDirections({
      set: { names: setSearch.vehicleMotionDirection, page: 1, limit: setSearch.vehicleMotionDirection.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.driverLicenceType && setSearch.driverLicenceType.length > 0) {
    const response = await getLicenceTypes({
      set: { names: setSearch.driverLicenceType, page: 1, limit: setSearch.driverLicenceType.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.passengerFaultStatus && setSearch.passengerFaultStatus.length > 0) {
    const response = await getFaultStatuses({
      set: { names: setSearch.passengerFaultStatus, page: 1, limit: setSearch.passengerFaultStatus.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
  ...
  if (setSearch?.pedestrianFaultStatus && setSearch.pedestrianFaultStatus.length > 0) {
    const response = await getFaultStatuses({
      set: { names: setSearch.pedestrianFaultStatus, page: 1, limit: setSearch.pedestrianFaultStatus.length || 10 } as any,
      get: { _id: 1, name: 1 },
    });
    if (response && Array.isArray(response)) {
