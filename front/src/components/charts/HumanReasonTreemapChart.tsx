...
const HumanReasonTreemapChart: React.FC<HumanReasonTreemapChartProps> = ({
  data,
  isLoading
}) => {
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-600">
              {data.length.toLocaleString('fa-IR')} عامل انسانی برتر شناسایی شده
            </span>
          </div>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-xs">
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#dbeafe' }}></div>
              <span>۱-۱۵ مورد</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#93c5fd' }}></div>
              <span>۱۶-۳۵ مورد</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#60a5fa' }}></div>
              <span>۳۶-۷۰ مورد</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#3b82f6' }}></div>
              <span>۷۱-۱۲۰ مورد</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#2563eb' }}></div>
              <span>۱۲۱-۲۰۰ مورد</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-sm border border-gray-200" style={{ backgroundColor: '#1d4ed8' }}></div>
              <span>۲۰۱+ مورد</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-amber-50 rounded-lg">
          ...
          <div className="text-xs text-amber-700 space-y-1">
            <div>• <strong>رفتاری:</strong> عدم رعایت حق تقدم، سرعت غیرمجاز، تغییر مسیر ناگهانی</div>
            <div>• <strong>فیزیولوژیک:</strong> خستگی، خواب‌آلودگی، مصرف مواد</div>
            <div>• <strong>توجه:</strong> استفاده از تلفن، عدم توجه به علائم</div>
            <div>• <strong>فنی:</strong> عدم حفظ فاصله ایمنی، نحوه رانندگی</div>
          </div>
        </div>
      </div>
    </div>
