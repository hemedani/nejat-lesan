  ...
  const chartOptions: ApexOptions = {
    ...
    tooltip: {
      custom: function({ series, seriesIndex, dataPointIndex, w }) {
        const dayName = w.globals.labels[seriesIndex] || 'نامشخص'
        const hour = w.globals.categoryLabels[dataPointIndex] || 'نامشخص'
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>• رنگ‌های روشن‌تر نشان‌دهنده تعداد تصادفات کمتر و رنگ‌های تیره‌تر نشان‌دهنده تعداد بیشتر هستند</li>
