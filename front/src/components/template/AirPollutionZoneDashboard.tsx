...
import AirPollutionZoneUpdateModal from "./AirPollutionZoneUpdateModal";
...
interface AirPollutionZoneDashboardProps {
  data: TData[];
  model: ModelName;
...
const AirPollutionZoneDashboard: React.FC<AirPollutionZoneDashboardProps> = ({
  data,
  model,
  remove,
  token,
  ...
  return (
    <div>
      ...
      {activeModal === "edit" && selectedItem && (
        <AirPollutionZoneUpdateModal
          isOpen
          onClose={closeModal}
          airPollutionZoneId={selectedItem._id}
          token={token}
          lesanUrl={lesanUrl}
...
export default AirPollutionZoneDashboard;