...
interface AppliedFiltersDisplayProps {
  ...
  /**
   * Whether to show a global filters indicator badge
   */
...
const AppliedFiltersDisplay: React.FC<AppliedFiltersDisplayProps> = ({
  ...
  const { hasGlobalFilters, globalFilterCount } = useGlobalChartFilters();
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 shadow-sm animate-in fade-in-50 duration-300">
      <div className="flex items-center gap-3 mb-6">
        ...
        {showGlobalIndicator && hasGlobalFilters && (
          <span className="inline-flex items-center gap-1 bg-indigo-100 text-indigo-700 text-xs px-2.5 py-1 rounded-full font-medium shadow-sm">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            </svg>
            {globalFilterCount} فیلتر عمومی
          </span>
        )}
      </div>
