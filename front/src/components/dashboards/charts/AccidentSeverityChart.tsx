...
const AccidentSeverityChart: React.FC<ChartProps> = ({ data, isLoading, isDamageActive }) => {
  ...
  const doughnutOptions: ApexOptions = {
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              fontWeight: 600,
              color: "#374151",
              formatter: () => formatNumber(totalCount),
            },
            value: {
              show: true,
              fontSize: "24px",
              fontWeight: 700,
              color: "#111827",
              formatter: (val: string) => formatNumber(parseInt(val)),
            },
          },
        },
      },
    ...
    tooltip: {
      enabled: true,
      y: {
        formatter: (val: number) => `${formatNumber(val)} مورد`,
      },
      style: {
        fontSize: "12px",
      },
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                d="M10 2C5.582 2 2 5.582 2 10s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM9 4a1 1 0 112 0v4a1 1 0 11-2 0V4zm0 8a1 1 0 112 0v2a1 1 0 11-2 0v-2z"
                clipRule="evenodd"
              />
            </svg>
      ...
      <div className="h-80">
        <Chart options={doughnutOptions} series={chartSeries} type="donut" height="100%" />
      </div>
