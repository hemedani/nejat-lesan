...
const EffectiveRoadDefectsDashboard: React.FC<DashboardProps> = ({ data, isLoading }) => {
  ...
  const doughnutOptions: ApexOptions = {
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              formatter: () =>
                formatNumber(
                  data.defectDistribution.withDefect + data.defectDistribution.withoutDefect,
                ),
            },
          },
        },
    ...
    dataLabels: {
      enabled: true,
      formatter: (val: number) => `${val.toLocaleString("fa-IR", { maximumFractionDigits: 1 })}%`,
      style: {
        fontSize: "14px",
        fontWeight: "bold",
        colors: ["#FFFFFF"],
    ...
    tooltip: {
      y: {
        formatter: (val: number) => {
          ...
          return `${formatNumber(val)} تصادف (${Number(percentage).toLocaleString("fa-IR")}%)`;
        },
      },
    },
    responsive: [
  ...
  const barOptions: ApexOptions = {
    ...
    tooltip: {
      y: {
        formatter: (val: number) => `${formatNumber(val)} تصادف`,
      },
    },
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">نقایص مؤثر راه</h2>
            <p className="text-gray-600">تحلیل نقش نقایص راه در وقوع تصادفات ترافیکی</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">درصد تصادفات دارای نقص راه</h3>
            <p className="text-sm text-gray-600">نسبت تصادفات دارای نقص مؤثر راه به کل تصادفات</p>
          </div>
          <Chart
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">انواع نقایص مؤثر راه</h3>
            <p className="text-sm text-gray-600">فراوانی انواع نقایص راه در تصادفات بررسی شده</p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">
                {formatNumber(data.defectDistribution.withDefect)}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">
                {formatNumber(data.defectDistribution.withoutDefect)}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600">
                {Number(
                  (
                    (data.defectDistribution.withDefect /
                      (data.defectDistribution.withDefect + data.defectDistribution.withoutDefect)) *
                    100
                  ).toFixed(1),
