...
|------|-----|-------|
| name | رشته | نام استان |
| english_name | رشته | نام انگلیسی استان |
| population | عدد | جمعیت استان |
| area | GeoJSON MultiPolygon | محدوده جغرافیایی استان |
| center_location | GeoJSON Point | نقطه مرکزی استان |
| createdAt | تاریخ | زمان ایجاد رکورد |
| updatedAt | تاریخ | زمان آخرین بروزرسانی |

## Relations

### From استان → Other Models

| Relation | Type | Target | Optional | Reverse |
|----------|------|--------|----------|---------|
| registrer | single | User | true | (none) |

### Reverse Relations (from other models → استان)
