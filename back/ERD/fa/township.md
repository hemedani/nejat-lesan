...
| فیلد | نوع | توضیح |
|------|-----|-------|
| name | رشته | نام شهرستان |
| english_name | رشته | نام انگلیسی شهرستان |
| population | عدد | جمعیت شهرستان |
| area | GeoJSON MultiPolygon | محدوده جغرافیایی شهرستان |
| center_location | GeoJSON Point | نقطه مرکزی شهرستان |
| createdAt | تاریخ | زمان ایجاد رکورد |
| updatedAt | تاریخ | زمان آخرین بروزرسانی |

## Relations

### From شهرستان → Other Models
...
### Reverse Relations (from other models → شهرستان)
