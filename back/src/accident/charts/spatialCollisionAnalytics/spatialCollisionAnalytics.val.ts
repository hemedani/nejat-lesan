/**
 * -----------------------------------------------------------------------------
 * FILE: spatialCollisionAnalytics.val.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "spatialCollisionAnalytics" act.
 *
 ...
 * - Deep spatial analysis of **collision types** (`collision_type.name`) by **city zone**
 *
 ...
 * and analyzes distribution of **collision_type.name** values.
 *
...
export const spatialCollisionAnalyticsValidator = () => {
	return object({
		set: object({
			...
			collisionType: optional(array(string())), // ← CRITICAL: collision types
