/**
 * -----------------------------------------------------------------------------
 * FILE: spatialLightAnalytics.val.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "spatialLightAnalytics" act.
 *
 ...
 * - Deep spatial analysis of **lighting conditions** (`light_status.name`) by **city zone**
 *
 ...
 * and analyzes distribution of **light_status.name** values.
 *
...
export const spatialLightAnalyticsValidator = () => {
	return object({
		set: object({
			...
			lightStatus: optional(array(string())), // ← CRITICAL: lighting conditions
