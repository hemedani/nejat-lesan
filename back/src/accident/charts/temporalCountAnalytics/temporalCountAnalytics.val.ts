 ...
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "temporalCountAnalytics" act.
 *
 ...
 * - Flexible time-series analysis of accident counts over time
 *
 ...
 * returns a single time-series of monthly accident counts.
 */
...
export const temporalCountAnalyticsValidator = () => {
	return object({
		...
		get: object({
			analytics: enums([1]), // Always returns monthly time-series
		}),
	});
};
