/**
 * -----------------------------------------------------------------------------
 * FILE: temporalSeverityAnalytics.fn.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Returns a **monthly time-series** showing the **percentage of fatal accidents**
 * among all **severe accidents** (i.e., Fatal + Injury).
 *
...
export const temporalSeverityAnalyticsFn: ActFn = async (body) => {
	...
	//    - Count fatal vs. injury
	//    - Compute % fatality share
	// =========================================================================
	...
	// =========================================================================
	// 8. BUILD CONTINUOUS MONTHLY SERIES
	...
	return {
		analytics: {
			categories,
			series: [{ name: "سهم تصادفات فوتی از شدید", data: seriesData }],
		},
	};
};
