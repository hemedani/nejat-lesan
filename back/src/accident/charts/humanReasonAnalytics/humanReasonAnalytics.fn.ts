/**
 * -----------------------------------------------------------------------------
 * FILE: humanReasonAnalytics.fn.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Returns the **top 8 human factors** (`human_reasons.name`) contributing to accidents,
 * **excluding "ندارد"** (None).
 *
 ...
 * - Uses `$unwind` on `human_reasons` to count each reason per accident
 * - Excludes "ندارد", null, and empty strings
 * - Returns top 8 results sorted by count (descending)
...
export const humanReasonAnalyticsFn: ActFn = async (body) => {
	...
	const contextFields: Record<string, string> = {
		...
		humanReasons: "human_reasons.name", // ← main focus
	...
	//    - Unwind human_reasons to count each reason per accident
	//    - Exclude "ندارد", null, and empty strings
	//    - Group, sort, limit to top 8
	// =========================================================================
