/**
 * -----------------------------------------------------------------------------
 * FILE: temporalUnlicensedDriversAnalytics.fn.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Returns a **monthly time-series** of accidents involving **at least one unlicensed driver**
 * (`driver.licence_type.name` = "فاقد گواهینامه").
 *
 ...
 * - Hardcoded filter for unlicensed drivers
...
export const temporalUnlicensedDriversAnalyticsFn: ActFn = async (body) => {
	...
	//    - Combine with existing unlicensed driver filter using $and
	// =========================================================================
	...
	// Combine with base unlicensed driver filter
