 ...
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "totalReasonAnalytics" act.
 *
 ...
 * - Deep, contextual analysis of "ultimate cause" (`total_reason`) in **severe accidents only**
 *
 ...
 * returns the top 10 ultimate causes.
 */
...
export const totalReasonAnalyticsValidator = () => {
	return object({
		...
		get: object({
			analytics: enums([1]), // Always returns top 10 ultimate causes
		}),
	});
};
