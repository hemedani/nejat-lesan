/**
 * -----------------------------------------------------------------------------
 * FILE: areaUsageAnalytics.fn.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Returns a breakdown of accident counts by land use type (`area_usages.name`).
 *
 ...
 * - Uses `$unwind` on `area_usages` to count each land use per accident
 * - Excludes null/empty land use entries
...
export const areaUsageAnalyticsFn: ActFn = async (body) => {
	...
	const contextFields: Record<string, string> = {
		...
		// Note: areaUsages is NOT filtered here — it's the output dimension
	...
	//    - Unwind area_usages to count each land use per accident
	//    - Exclude null/empty
	//    - Group and sort
	// =========================================================================
