 ...
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "areaUsageAnalytics" act.
 *
 ...
 * - Deep, contextual analysis of land use ("area_usages") patterns
 *
 ...
 * returns the full land use distribution.
 */
...
export const areaUsageAnalyticsValidator = () => {
	return object({
		set: object({
			...
			areaUsages: optional(array(string())), // ← main focus of this chart
