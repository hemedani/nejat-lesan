 ...
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Validator for the "spatialSingleVehicleAnalytics" act.
 *
 ...
 * - Deep spatial analysis of **single-vehicle accidents** by **city zone**
 *
 ...
 *
 * ⚠️ **Critical**: This act **only analyzes single-vehicle accidents**:
...
export const spatialSingleVehicleAnalyticsValidator = () => {
	return object({
		set: object({
			...
			collisionType: optional(array(string())), // ← used for map ratio
