/**
 * -----------------------------------------------------------------------------
 * FILE: spatialSingleVehicleAnalytics.fn.ts
 * -----------------------------------------------------------------------------
 * DESCRIPTION:
 * Returns **dual analytics** for **single-vehicle accidents** by **city zone**:
 * 1. **Stacked bar chart**: Counts of each single-vehicle type per zone
 * 2. **Zonal map**: % of user-selected (or default) single-vehicle type among severe single-vehicle accidents
 *
 ...
 * - Hardcoded filter for 3 single-vehicle types
...
export const spatialSingleVehicleAnalyticsFn: ActFn = async (body) => {
	...
	// =========================================================================
	// 5. DEFAULT TO USER'S CITY OR "اهواز" IF NO CITY SELECTED
	// =========================================================================
	...
	// =========================================================================
	// 6. APPLY VEHICLE_DTOs FILTERS ($elemMatch)
	// =========================================================================
	...
	// =========================================================================
	// 7. APPLY PEDESTRIAN_DTOs FILTERS ($elemMatch)
	// =========================================================================
	...
	// =========================================================================
	// 9. DEFINE COLLISION TYPES FOR MAP RATIO
	// =========================================================================
	...
	// =========================================================================
	// 10. EXECUTE $FACET AGGREGATION
	//    - Only zones with city_zone.name
	//    - Bar chart: all 3 single-vehicle types
	//    - Map chart: % of selected type among severe single-vehicle accidents
	// =========================================================================
	...
	// =========================================================================
	// 11. FORMAT BAR CHART DATA
	// =========================================================================
	const categories = data.barChartData.map((item: any) => item.name);
	const series = singleVehicleTypes.map((type) => ({
		name: type,
